...
export default function WithSubNav() {
        ...
        >
          ...
          <Menu>
            ...
            <MenuList
              ...
              rounded={"xl"}
            >
              <Avatar size={"2xl"} boxShadow="xl" src={"./avatar.png"} />

              <Text py={4}>Muhammetbilgin@hattat.com</Text>
            </MenuList>
          </Menu>
        </Stack>
      </Flex>
    ...
    >
      <Stack direction={"row"} align={"center"}>
        ...
        <Flex
          ...
          flex={1}
        >
          <Icon color={"#016C69"} w={5} h={5} as={FiChevronRight} />
        </Flex>
      </Stack>
    </Link>
  );
